        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="card-title">{{__('b.contant_edit')}}</h4>
                    <a href="{{ route('content.index') }}" class="btn btn-primary btn-sm">{{__('b.back')}}</a> 
                </div>
                ...
                <input type="hidden" name="_method" value="PUT">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">{{ __('b.contant_name') }}</label>
                                <div>
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <select name="status" id="" class="form-select @error('status') is-invalid @enderror" aria-label="Default select example">
                                        ...
                                        <option value="active" @if($content->status == 'active') selected @endif>{{ __('b.active') }}</option>
                                        <option value="inactive" @if($content->status == 'inactive') selected @endif>{{ __('b.inactive') }}</option>
                                    </select> 
