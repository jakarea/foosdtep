...
@section('title') Manage Productgroup @endsection
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-4">
                        <span>
                        <h4 class="card-title">{{__('b.productgrp_list')}}</h4> 
                        </span>
                        <a href="{{ route('productgroup.create') }}" class="btn btn-primary btn-sm">{{__('b.add_productgrp')}}</a> 
                    </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach( $productgroup as $key => $data )
                            <tr id="table_rrow{{$data->id}}">
                                ...
                                <td valign="middle">
                                    <a href="{{ route('productgroup.edit', $data->slug) }}" class="me-2"><i class="fas fa-pencil-alt"></i></a>
    ...
    $(document).on('click', '.cat_delete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "DELETE",
                    url:  "{{url('/auth/productsgrpup/productgroup')}}/" + id,
