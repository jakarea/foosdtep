...
@section('content')
 ...
 <main id="main-container" class="main-container pb-0">
        ...
        <div class="product m-t-100">
         ...
         <div class="banner m-t-100 pos-relative custom-bg-ol">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="banner__content banner__content--center pos-absolute">
                                <h6 class="banner__title  font--medium m-b-10" style="color: #fff;">{{ __('text.special_discount')}}</h6>
                                <h1 class="banner__title banner__title--large font--regular text-capitalize" style="color: #fff;">{{ __('text.for_all_grocery')}} <br></h1>
                                <h6 class="banner__title font--medium m-b-40" style="color: #fff;">{{ __('text.20_off')}}</h6>
